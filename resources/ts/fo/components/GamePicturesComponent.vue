  ...
  new Swiper(".swiper-games-related", {
    ...
    pagination: {
      ...
      renderBullet: function (index: number, className: string) {
        return "<button class='btn btn-primary rounded-circle border-0 mx-2 p-0 " + className +
          "' title='" + trans.methods.__("fo_slide_id",{"slideId": String(index + 1)}) +
          "' aria-label='" + trans.methods.__("fo_slide_id_aria",{"slideId": String(index + 1)}) +
          "' type='button'></button>";
      },
    },
    breakpoints: {
